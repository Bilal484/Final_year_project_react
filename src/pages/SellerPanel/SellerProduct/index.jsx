    ...
    const handleSubmit = async () => {
        try {
            if (step === 1) {
                ...
                formData.append("p_id", selectedProduct ? selectedProduct.value : '');
    ...
    const handleDeleteProduct = async () => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                toast.error(`Failed to delete product. Status Code: ${response.status}`);
            }
        } catch (error) {
            if (error.response) {
                // Server responded with a status other than 2xx
                console.error('Error Response:', error.response);
                toast.error(`Error: ${error.response.data.message || 'Failed to delete product.'}`);
    ...
    return (
        <>
            ...
            <Helmet>
                ...
                <meta
                    name="description"
                    content="Manage your seller products, including adding, updating, and uploading media for product listings."
                />
                <meta
                    name="keywords"
                                            ...
                                            <Col md={4} key={product.id} className="mb-4">
                                                <Card className="h-100">
                                                    <Card.Body>
                                                        ...
                                                        {/* Delete Button */}
                                                        <Button variant="danger" onClick={() => handleOpenDeleteModal(product)}>
                                                            Delete
                                                        </Button>
                                                    </Card.Body>
                                                </Card>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-9 mx-auto">
                                            <Form>
                                                ...
                                                <Button className="mt-3" variant="primary" onClick={handleSubmit}>Save Product</Button>
                                            </Form>
                                        </div>
                                    </div>
                                </Tab.Pane>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-9 mx-auto">
                                            <Form>
                                                ...
                                                <Button className="mt-3" variant="primary" onClick={handleOverviewSubmit}>Submit Overview</Button>
                                            </Form>
                                        </div>
                                    </div>
                                </Tab.Pane>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-9 mx-auto">
                                            <Form>
                                                ...
                                                <Button className="mt-3" variant="primary" onClick={handleImageUpload}>Upload Images</Button>
                                            </Form>
                                        </div>
                                    </div>
                                </Tab.Pane>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-9 mx-auto">
                                            <Form>
                                                ...
                                                <Button className="mt-3" variant="primary" onClick={handleFloorImageUpload}>Submit Floor Image</Button>
                                            </Form>
                                        </div>
                                    </div>
                                </Tab.Pane>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-9 mx-auto">
                                            <Form>
                                                ...
                                                <Button className="mt-3" variant="primary" onClick={handleVideoUpload}>Upload Videos</Button>
                                            </Form>
                                        </div>
                                    </div>
                                </Tab.Pane>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-9 mx-auto">
                                            <Form>
                                                ...
                                                <Button className="mt-3" variant="primary" onClick={handleHomeTagSubmit}>Submit Home Tag</Button>
                                            </Form>
                                        </div>
                                    </div>
                                </Tab.Pane>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-9 mx-auto">
                                            <Form>
                                                ...
                                                <Button className="mt-3" variant="primary" onClick={handleHomeIconSubmit}>Submit Home Icon</Button>
                                            </Form>
                                        </div>
                                    </div>
                                </Tab.Pane>
